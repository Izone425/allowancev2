...
const MOCK_USERS: User[] = [
  { id: 'user_001', name: 'Ahmad Bin Abdullah', code: 'EMP001', email: 'ahmad@company.com', department: 'Engineering', departmentId: 'dept_eng', branch: 'HQ', branchId: 'branch_hq', position: 'Senior Engineer', jobGrade: 6, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2020-03-15', tenureMonths: 57 },
  { id: 'user_002', name: 'Siti Nurhaliza', code: 'EMP002', email: 'siti@company.com', department: 'Sales', departmentId: 'dept_sales', branch: 'HQ', branchId: 'branch_hq', position: 'Sales Executive', jobGrade: 4, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2021-06-01', tenureMonths: 42 },
  { id: 'user_003', name: 'Raj Kumar', code: 'EMP003', email: 'raj@company.com', department: 'IT', departmentId: 'dept_it', branch: 'HQ', branchId: 'branch_hq', position: 'System Administrator', jobGrade: 5, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2019-01-10', tenureMonths: 71 },
  { id: 'user_004', name: 'Lee Wei Ming', code: 'EMP004', email: 'weiming@company.com', department: 'Finance', departmentId: 'dept_finance', branch: 'HQ', branchId: 'branch_hq', position: 'Accountant', jobGrade: 5, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2022-02-14', tenureMonths: 34 },
  { id: 'user_005', name: 'Nurul Aisyah', code: 'EMP005', email: 'nurul@company.com', department: 'HR', departmentId: 'dept_hr', branch: 'HQ', branchId: 'branch_hq', position: 'HR Executive', jobGrade: 4, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2021-09-01', tenureMonths: 39 },
  { id: 'user_006', name: 'Muhammad Faiz', code: 'EMP006', email: 'faiz@company.com', department: 'Marketing', departmentId: 'dept_marketing', branch: 'Branch A', branchId: 'branch_a', position: 'Marketing Officer', jobGrade: 4, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2023-01-15', tenureMonths: 23 },
  { id: 'user_007', name: 'Tan Mei Ling', code: 'EMP007', email: 'meiling@company.com', department: 'Engineering', departmentId: 'dept_eng', branch: 'HQ', branchId: 'branch_hq', position: 'Junior Engineer', jobGrade: 3, employmentType: 'PERMANENT', isConfirmed: false, joinDate: '2024-06-01', tenureMonths: 6 },
  { id: 'user_008', name: 'Muthu Krishnan', code: 'EMP008', email: 'muthu@company.com', department: 'Operations', departmentId: 'dept_ops', branch: 'Branch B', branchId: 'branch_b', position: 'Operations Manager', jobGrade: 7, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2018-05-20', tenureMonths: 79 },
  { id: 'user_009', name: 'Aisha Rahman', code: 'EMP009', email: 'aisha@company.com', department: 'Sales', departmentId: 'dept_sales', branch: 'Branch A', branchId: 'branch_a', position: 'Sales Manager', jobGrade: 6, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2019-11-01', tenureMonths: 61 },
  { id: 'user_010', name: 'Wong Jia Wei', code: 'EMP010', email: 'jiawei@company.com', department: 'IT', departmentId: 'dept_it', branch: 'HQ', branchId: 'branch_hq', position: 'IT Manager', jobGrade: 8, employmentType: 'PERMANENT', isConfirmed: true, joinDate: '2017-03-01', tenureMonths: 93 },
  { id: 'user_011', name: 'Fatimah Zahra', code: 'CON001', email: 'fatimah@company.com', department: 'Marketing', departmentId: 'dept_marketing', branch: 'HQ', branchId: 'branch_hq', position: 'Content Writer', jobGrade: 3, employmentType: 'CONTRACT', isConfirmed: true, joinDate: '2024-01-15', tenureMonths: 11 },
  { id: 'user_012', name: 'Arjun Singh', code: 'INT001', email: 'arjun@company.com', department: 'Engineering', departmentId: 'dept_eng', branch: 'HQ', branchId: 'branch_hq', position: 'Intern', jobGrade: 1, employmentType: 'INTERN', isConfirmed: false, joinDate: '2024-09-01', tenureMonths: 3 }
];
